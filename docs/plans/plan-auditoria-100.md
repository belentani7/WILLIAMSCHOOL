# Plan -- Auditoria y documentacion al 100% (WILLIAMSCHOOL)
...
- [x] `docs/prd/prd-williamschool.md`.
- [x] `docs/srs/srs-williamschool.md`.
- [x] `docs/design/design-williamschool.md`.
